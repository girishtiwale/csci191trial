...
void _parallax::renderBack(float width, float height)
{
    ...
    glBegin(GL_POLYGON);
    glTexCoord2f(xMin,yMax);                    // type I want to draw
    glVertex3f(-width/height,-1,-8.0);          // coordinates x,y,z
    glTexCoord2f(xMax,yMax);                    // type I want to draw
    glVertex3f(width/height,-1,-8.0);
    glTexCoord2f(xMax,yMin);                    // type I want to draw
    glVertex3f(width/height,1,-8.0);
    glTexCoord2f(xMin,yMin);                    // type I want to draw
    glVertex3f(-width/height,1,-8.0);
    glEnd();
}
